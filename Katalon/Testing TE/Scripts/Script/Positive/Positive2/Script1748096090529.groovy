...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/div_Login'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Login'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/a_CURA Healthcare_menu-toggle'))

WebUI.verifyElementPresent(findTestObject('Page_CURA Healthcare Service/a_History'), 5)
