...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_CURA Healthcare Service/Page_/a_Home'), 5)

WebUI.verifyElementPresent(findTestObject('Page_/a_Login'),5)
